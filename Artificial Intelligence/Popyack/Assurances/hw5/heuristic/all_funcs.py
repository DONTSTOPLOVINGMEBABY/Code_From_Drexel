...
what_we_working_with_here = [['w', 'w', 'w', 'w', '.', 'b'], ['w', 'w', '.', '.', 'b', '.'], ['w', '.', 'w', 'b', '.', '.'], ['w', '.', 'b', '.', '.', '.'], ['.', '.', '.', '.', '.', '.'], ['b', 'b', 'b', 'b', '.', '.']]





for i in what_we_working_with_here:
    print(i)
...
evaluation = final_call('w', what_we_working_with_here)

print(evaluation)

print(horizontal_straights(what_we_working_with_here, 'w'))
print(vertical_straight(what_we_working_with_here, 'w'))
print(get_diagonal_score(what_we_working_with_here,'w'))
